...
typedef grpc_channel_credentials*(*grpc_ssl_credentials_create_with_request_type_type)(const char* pem_root_certs, grpc_ssl_pem_key_cert_pair* pem_key_cert_pair, grpc_ssl_server_certificate_request_type type);
extern grpc_ssl_credentials_create_with_request_type_type grpc_ssl_credentials_create_with_request_type_import;
#define grpc_ssl_credentials_create_with_request_type grpc_ssl_credentials_create_with_request_type_import
