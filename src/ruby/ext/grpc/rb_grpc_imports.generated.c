...
grpc_ssl_credentials_create_with_request_type_type grpc_ssl_credentials_create_with_request_type_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_ssl_credentials_create_with_request_type_import = (grpc_ssl_credentials_create_with_request_type_type) GetProcAddress(library, "grpc_ssl_credentials_create_with_request_type");
